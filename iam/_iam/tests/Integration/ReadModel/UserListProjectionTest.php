        ...
        self::assertEquals(
            ...
            $this->getTestSupport()
                ...
                ->withEventsFor($userId, User::class, [
                    ...
                    new UserRoleWasAssigned($userId, 'ROLE_ALPHA'),
                    new UserRoleWasAssigned($userId, 'ROLE_BETA'),
                    new RoleWasRevoked($userId, 'ROLE_ALPHA'),
                    new RoleWasRevoked($userId, 'ROLE_BETA'),
                ])
